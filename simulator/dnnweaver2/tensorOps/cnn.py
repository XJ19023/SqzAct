...
class MatMul(NodeOp):
    def __init__(self, data, weights, biases, name, dtype=None, int8_ratio=1):
...
def matmul(i, w, b, name=None, dtype=None, int8_ratio=1):
    g = get_default_graph()
    op = MatMul(i, w, b, name=name, dtype=dtype, int8_ratio=int8_ratio)
    return typecast(op.output_tensors, dtype)
