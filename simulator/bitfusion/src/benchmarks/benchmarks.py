...
import bitfusion.src.benchmarks.mant_bench as mant
import bitfusion.src.benchmarks.olive_bench as olive
import bitfusion.src.benchmarks.spark_bench as spark
import bitfusion.src.benchmarks.squeeze_bench as squeeze
...
def create_net(net_name, net_list, batch_size):
    ...
    with g.as_default():
        for idx, op in enumerate(net_list):
            try:
                input_size, kernel_size, output_size, kernel_stride, padding, precision, op_type, int8_ratio =  op
            except:
            ...
            if op_type == 0:
                ...
                with g.name_scope('fc'+str(idx)):
                    out = create_fc(input_size, kernel_size, c_dtype=precision, w_dtype=FQDtype.FXP4, int8_ratio=int8_ratio)
                    # print(idx, op, out.shape)
                    assert out.shape[0] == output_size[0]
...
def create_fc(input_size, weight_size, c_dtype=None, w_dtype=None, int8_ratio=1):
    batch_size = input_size[0]
    output_channels = weight_size[0]
    input_channels = weight_size[1]
    ...
    biases = get_tensor(shape=(output_channels,), name='biases', dtype=c_dtype)
    _fc = matmul(input, weights, biases, dtype=c_dtype, int8_ratio=int8_ratio)
    return _fc

benchlist = [\
            #  'cola', 
             'wikitext_TinyLlama_1_1B_Chat_v1_0', 
             'wikitext_llama_2_7b_hf', 
             'wikitext_Meta_Llama_3_8B', 
             'wikitext_Qwen2_5_0_5B', 
             'wikitext_Qwen2_5_1_5B', 
             'wikitext_Qwen2_5_7B', 
            ]
...
def get_bench_nn_mant(bench_name, batch_size):
    if bench_name == 'wikitext_Qwen2_5_0_5B':
        return create_net(bench_name, mant.wikitext_Qwen2_5_0_5B, batch_size)
    elif bench_name == 'wikitext_TinyLlama_1_1B_Chat_v1_0':
        return create_net(bench_name, mant.wikitext_TinyLlama_1_1B_Chat_v1_0, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_1_5B':
        return create_net(bench_name, mant.wikitext_Qwen2_5_1_5B, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_7B':
        return create_net(bench_name, mant.wikitext_Qwen2_5_7B, batch_size)
    elif bench_name == 'wikitext_llama_2_7b_hf':
        return create_net(bench_name, mant.wikitext_llama_2_7b_hf, batch_size)
    elif bench_name == 'wikitext_Meta_Llama_3_8B':
        return create_net(bench_name, mant.wikitext_Meta_Llama_3_8B, batch_size)
    else:
        raise SystemError
    
def get_bench_nn_olive(bench_name, batch_size):
    if bench_name == 'wikitext_Qwen2_5_0_5B':
        return create_net(bench_name, olive.wikitext_Qwen2_5_0_5B, batch_size)
    elif bench_name == 'wikitext_TinyLlama_1_1B_Chat_v1_0':
        return create_net(bench_name, olive.wikitext_TinyLlama_1_1B_Chat_v1_0, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_1_5B':
        return create_net(bench_name, olive.wikitext_Qwen2_5_1_5B, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_7B':
        return create_net(bench_name, olive.wikitext_Qwen2_5_7B, batch_size)
    elif bench_name == 'wikitext_llama_2_7b_hf':
        return create_net(bench_name, olive.wikitext_llama_2_7b_hf, batch_size)
    elif bench_name == 'wikitext_Meta_Llama_3_8B':
        return create_net(bench_name, olive.wikitext_Meta_Llama_3_8B, batch_size)
    else:
        raise SystemError

def get_bench_nn_spark(bench_name, batch_size):
    if bench_name == 'wikitext_Qwen2_5_0_5B':
        return create_net(bench_name, spark.wikitext_Qwen2_5_0_5B, batch_size)
    elif bench_name == 'wikitext_TinyLlama_1_1B_Chat_v1_0':
        return create_net(bench_name, spark.wikitext_TinyLlama_1_1B_Chat_v1_0, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_1_5B':
        return create_net(bench_name, spark.wikitext_Qwen2_5_1_5B, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_7B':
        return create_net(bench_name, spark.wikitext_Qwen2_5_7B, batch_size)
    elif bench_name == 'wikitext_llama_2_7b_hf':
        return create_net(bench_name, spark.wikitext_llama_2_7b_hf, batch_size)
    elif bench_name == 'wikitext_Meta_Llama_3_8B':
        return create_net(bench_name, spark.wikitext_Meta_Llama_3_8B, batch_size)
    else:
        raise SystemError

def get_bench_nn_squeeze(bench_name, batch_size):
    if bench_name == 'wikitext_Qwen2_5_0_5B':
        return create_net(bench_name, squeeze.wikitext_Qwen2_5_0_5B, batch_size)
    elif bench_name == 'wikitext_TinyLlama_1_1B_Chat_v1_0':
        return create_net(bench_name, squeeze.wikitext_TinyLlama_1_1B_Chat_v1_0, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_1_5B':
        return create_net(bench_name, squeeze.wikitext_Qwen2_5_1_5B, batch_size)
    elif bench_name == 'wikitext_Qwen2_5_7B':
        return create_net(bench_name, squeeze.wikitext_Qwen2_5_7B, batch_size)
    elif bench_name == 'wikitext_llama_2_7b_hf':
        return create_net(bench_name, squeeze.wikitext_llama_2_7b_hf, batch_size)
    elif bench_name == 'wikitext_Meta_Llama_3_8B':
        return create_net(bench_name, squeeze.wikitext_Meta_Llama_3_8B, batch_size)
    else:
        raise SystemError
